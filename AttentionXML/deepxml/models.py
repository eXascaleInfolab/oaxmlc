...
from AttentionXML.deepxml.evaluation import get_p_5, get_n_5
from AttentionXML.deepxml.modules import *
from AttentionXML.deepxml.optimizers import *
...
class Model(object):
    ...
    def train_step(self, train_x: torch.Tensor, train_y: torch.Tensor):
        ...
        return loss.item(), (gradient_norms, gradient_lengths)
